...
class PhaetonExplorerFrame(ttk.Frame):
    def __init__(self, parent, log_callback):
        ...
        # Configuração do editor clássico com cores escuras e cursor visível (insertbackground)
        ...
        # Menu de contexto clássico (Clique direito) estilizado em dark mode
    ...
    # --- MENU DE CONTEXTO E OPERAÇÕES DE ARQUIVOS (DIREITOS NO WINDOWS) ---
